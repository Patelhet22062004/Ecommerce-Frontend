...
export default function Contact() {
  const [defaultZoom, setDefaultZoom] = useState(7); // Default zoom level for refresh/reset
  const iframeRef = useRef(null);

  const handleReset = () => {
    if (iframeRef.current) {
      // Update the iframe src to reset the zoom level
      iframeRef.current.src = `https://www.google.com/maps/d/embed?mid=1Ijnvt9DzyKqHj5bo3yjtlTYFMbVZ2so&ehbc=2E312F&z=${defaultZoom}`;
    }
  };
    return (
    <>
    <div className="flex flex-wrap justify-around items-center text=[#f9f9f9]">
      ...
      <section className="mb-32">
        ...
        <div style={{ position: "relative", width: "100%", height: "680px" }}>
          <button onClick={handleReset} style={{ border: 0, position: "absolute", top: "50px" ,zIndex:"2",marginLeft:'20px', backgroundColor:'white', borderRadius:'3px', color:'gray', padding:'4px'}}>reset</button>
        <iframe  
  ref={iframeRef}
  src={`https://www.google.com/maps/d/embed?mid=1Ijnvt9DzyKqHj5bo3yjtlTYFMbVZ2so&ehbc=2E312F&z=${defaultZoom}`}
          width="100%" height={680} 
         style={{ border: 0, position: "absolute", top: "-60px" }} // Adjust top to clip header
        ...
        <div className="container px-6 md:px-12">
          <div className="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
            <div className="flex flex-wrap">
              ...
              <div className=" shrink-0 grow-0 basis-auto lg:w-7/12">
                <div className="flex flex-wrap">
